...
{
    CFunctionProfiler::g_pProfiler->FunctionEnter2(funcID, clientData, func, argumentInfo);
}
...
{
     CFunctionProfiler::g_pProfiler->FunctionLeave2(funcID, clientData, func, retvalRange);
}
...
void __stdcall FunctionTailcall2Global(
    ...
    /*[in]*/COR_PRF_FRAME_INFO                  func)
{
     CFunctionProfiler::g_pProfiler->FunctionTailcall2(funcID, clientData, func);
}
